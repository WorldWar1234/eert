...
import { generateRandomIP, randomUserAgent } from './user.js';
import { copyHeaders as copyHdrs } from './copyh.js';
import { compressImg as applyCompression } from './comp.js';
import { bypass as performBypass } from './byp.js';
import { redirect as handleRedirect } from './rrd.js';
import { shouldCompress as checkCompression } from './scomp.js';
